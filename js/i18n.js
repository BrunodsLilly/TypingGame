...
const I18N = {
    en: {
        ...
        pgFixed: 'Fixed',
        pgFinales: 'Finales',
        pgTrickyTitle: 'Tricky Ones — Try Again!',
        pgTrickyHint: 'Tap one (or press its number) to try that exact one again!',
    ...
    pt: {
        ...
        pgFixed: 'Consertados',
        pgFinales: 'Finais',
        pgTrickyTitle: 'Dif\u00EDceis \u2014 Tente de Novo!',
        pgTrickyHint: 'Toque em um (ou aperte o n\u00FAmero) para tentar de novo!',
